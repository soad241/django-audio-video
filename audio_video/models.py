...
class Video(models.Model):
    ...
    upload_file = VideoFileField(_('upload video file'), upload_to='video/upload')
    flv_file = VideoFileField(_('final video file'), upload_to='video/flv', blank=True,
        duration_field='duration', width_field='width', height_field='height', read_only=True)
    splash_image = models.ImageField(_('splash image'), upload_to='video/splash', blank=True)
...
class Audio(models.Model):
    ...
    title = models.CharField(_('title'), max_length=40)
    description = models.TextField(_('description'), blank=True)
    file = AudioFileField(_('audio file'), upload_to='audio', duration_field='duration', bitrate_field='bitrate')
    date = models.DateTimeField(_('release date'), blank=True, null=True)
    tags = TagField(verbose_name=_('tags'), help_text=tagfield_help_text)
    duration = DurationField(_('duration'), blank=True, null=True)
